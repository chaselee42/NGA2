...
module spcomp_class
    ...
    type :: spcomp
       ...
       ! Density-weighted face velocity
       real(WP), dimension(:,:,:), allocatable :: Ufx,Ufy,Ufz,Vfx,Vfy,Vfz,Wfx,Wfy,Wfz
 ...
 contains
    ...
    subroutine initialize(this,cfg,name)
       ...
       ! Density-weighted face velocities
       allocate(this%Ufx(this%cfg%imino_:this%cfg%imaxo_,this%cfg%jmino_:this%cfg%jmaxo_,this%cfg%kmino_:this%cfg%kmaxo_)); this%Ufx=0.0_WP
       allocate(this%Vfx(this%cfg%imino_:this%cfg%imaxo_,this%cfg%jmino_:this%cfg%jmaxo_,this%cfg%kmino_:this%cfg%kmaxo_)); this%Vfx=0.0_WP
       allocate(this%Wfx(this%cfg%imino_:this%cfg%imaxo_,this%cfg%jmino_:this%cfg%jmaxo_,this%cfg%kmino_:this%cfg%kmaxo_)); this%Wfx=0.0_WP
       allocate(this%Ufy(this%cfg%imino_:this%cfg%imaxo_,this%cfg%jmino_:this%cfg%jmaxo_,this%cfg%kmino_:this%cfg%kmaxo_)); this%Ufy=0.0_WP
       allocate(this%Vfy(this%cfg%imino_:this%cfg%imaxo_,this%cfg%jmino_:this%cfg%jmaxo_,this%cfg%kmino_:this%cfg%kmaxo_)); this%Vfy=0.0_WP
       allocate(this%Wfy(this%cfg%imino_:this%cfg%imaxo_,this%cfg%jmino_:this%cfg%jmaxo_,this%cfg%kmino_:this%cfg%kmaxo_)); this%Wfy=0.0_WP
       allocate(this%Ufz(this%cfg%imino_:this%cfg%imaxo_,this%cfg%jmino_:this%cfg%jmaxo_,this%cfg%kmino_:this%cfg%kmaxo_)); this%Ufz=0.0_WP
       allocate(this%Vfz(this%cfg%imino_:this%cfg%imaxo_,this%cfg%jmino_:this%cfg%jmaxo_,this%cfg%kmino_:this%cfg%kmaxo_)); this%Vfz=0.0_WP
       allocate(this%Wfz(this%cfg%imino_:this%cfg%imaxo_,this%cfg%jmino_:this%cfg%jmaxo_,this%cfg%kmino_:this%cfg%kmaxo_)); this%Wfz=0.0_WP
       ...
       ! Density-weighted face pressures
       allocate(this%Pfx(this%cfg%imino_:this%cfg%imaxo_,this%cfg%jmino_:this%cfg%jmaxo_,this%cfg%kmino_:this%cfg%kmaxo_)); this%Pfx=0.0_WP
       allocate(this%Pfy(this%cfg%imino_:this%cfg%imaxo_,this%cfg%jmino_:this%cfg%jmaxo_,this%cfg%kmino_:this%cfg%kmaxo_)); this%Pfy=0.0_WP
       allocate(this%Pfz(this%cfg%imino_:this%cfg%imaxo_,this%cfg%jmino_:this%cfg%jmaxo_,this%cfg%kmino_:this%cfg%kmaxo_)); this%Pfz=0.0_WP
    ...
    subroutine rhs(this,dQdt)
       ...
       ! Zero out face velocities
       this%Ufx=0.0_WP; this%Ufy=0.0_WP; this%Ufz=0.0_WP
       this%Vfx=0.0_WP; this%Vfy=0.0_WP; this%Vfz=0.0_WP 
       this%Wfx=0.0_WP; this%Wfy=0.0_WP; this%Wfz=0.0_WP

       ! Compute density-weighted face velocities used for transport
       do k=this%cfg%kmin_-1,this%cfg%kmax_+2
          do j=this%cfg%jmin_-1,this%cfg%jmax_+2
             do i=this%cfg%imin_-1,this%cfg%imax_+2
                this%Ufx(i,j,k)=(0.5_WP*this%U(i,j,k)*this%Q(i,j,k,1)+0.5_WP*this%U(i-1,j,k)*this%Q(i-1,j,k,1))/(0.5_WP*(this%Q(i,j,k,1)+this%Q(i-1,j,k,1)))
                this%Ufy(i,j,k)=(0.5_WP*this%U(i,j,k)*this%Q(i,j,k,1)+0.5_WP*this%U(i,j-1,k)*this%Q(i,j-1,k,1))/(0.5_WP*(this%Q(i,j,k,1)+this%Q(i,j-1,k,1)))
                this%Ufz(i,j,k)=(0.5_WP*this%U(i,j,k)*this%Q(i,j,k,1)+0.5_WP*this%U(i,j,k-1)*this%Q(i,j,k-1,1))/(0.5_WP*(this%Q(i,j,k,1)+this%Q(i,j,k-1,1)))
                this%Vfx(i,j,k)=(0.5_WP*this%V(i,j,k)*this%Q(i,j,k,1)+0.5_WP*this%V(i-1,j,k)*this%Q(i-1,j,k,1))/(0.5_WP*(this%Q(i,j,k,1)+this%Q(i-1,j,k,1)))
                this%Vfy(i,j,k)=(0.5_WP*this%V(i,j,k)*this%Q(i,j,k,1)+0.5_WP*this%V(i,j-1,k)*this%Q(i,j-1,k,1))/(0.5_WP*(this%Q(i,j,k,1)+this%Q(i,j-1,k,1)))
                this%Vfz(i,j,k)=(0.5_WP*this%V(i,j,k)*this%Q(i,j,k,1)+0.5_WP*this%V(i,j,k-1)*this%Q(i,j,k-1,1))/(0.5_WP*(this%Q(i,j,k,1)+this%Q(i,j,k-1,1)))
                this%Wfx(i,j,k)=(0.5_WP*this%W(i,j,k)*this%Q(i,j,k,1)+0.5_WP*this%W(i-1,j,k)*this%Q(i-1,j,k,1))/(0.5_WP*(this%Q(i,j,k,1)+this%Q(i-1,j,k,1)))
                this%Wfy(i,j,k)=(0.5_WP*this%W(i,j,k)*this%Q(i,j,k,1)+0.5_WP*this%W(i,j-1,k)*this%Q(i,j-1,k,1))/(0.5_WP*(this%Q(i,j,k,1)+this%Q(i,j-1,k,1)))
                this%Wfz(i,j,k)=(0.5_WP*this%W(i,j,k)*this%Q(i,j,k,1)+0.5_WP*this%W(i,j,k-1)*this%Q(i,j,k-1,1))/(0.5_WP*(this%Q(i,j,k,1)+this%Q(i,j,k-1,1)))
                this%Pfx(i,j,k)=(0.5_WP*this%P(i-1,j,k)*this%Q(i,j,k,1)+0.5_WP*this%P(i,j,k)*this%Q(i-1,j,k,1))/(0.5_WP*(this%Q(i,j,k,1)+this%Q(i-1,j,k,1)))
                this%Pfy(i,j,k)=(0.5_WP*this%P(i,j-1,k)*this%Q(i,j,k,1)+0.5_WP*this%P(i,j,k)*this%Q(i,j-1,k,1))/(0.5_WP*(this%Q(i,j,k,1)+this%Q(i,j-1,k,1)))
                this%Pfz(i,j,k)=(0.5_WP*this%P(i,j,k-1)*this%Q(i,j,k,1)+0.5_WP*this%P(i,j,k)*this%Q(i,j,k-1,1))/(0.5_WP*(this%Q(i,j,k,1)+this%Q(i,j,k-1,1)))
             end do
          end do
       end do
       ...
       do k=this%cfg%kmin_,this%cfg%kmax_+1
          do j=this%cfg%jmin_,this%cfg%jmax_+1
             do i=this%cfg%imin_,this%cfg%imax_+1
                ...
                FQx(i,j,k,1)=-0.5_WP*(this%Ufx(i,j,k)+abs(this%Ufx(i,j,k)))*sum(wenop*this%Q(i-2:i  ,j,k,1))&
                &            -0.5_WP*(this%Ufx(i,j,k)-abs(this%Ufx(i,j,k)))*sum(wenom*this%Q(i-1:i+1,j,k,1))
                ! Centered  mass flux
                ...
                FQx(i,j,k,3)=FQx(i,j,k,1)*0.5_WP*sum(this%U(i-1:i,j,k))-this%Pfx(i,j,k)
                ...
                FQy(i,j,k,1)=-0.5_WP*(this%Vfy(i,j,k)+abs(this%Vfy(i,j,k)))*sum(wenop*this%Q(i,j-2:j  ,k,1))&
                &            -0.5_WP*(this%Vfy(i,j,k)-abs(this%Vfy(i,j,k)))*sum(wenom*this%Q(i,j-1:j+1,k,1))
                ! Centered mass flux
                ...
                FQy(i,j,k,4)=FQy(i,j,k,1)*0.5_WP*sum(this%V(i,j-1:j,k))-this%Pfy(i,j,k)
                ...
                FQz(i,j,k,1)=-0.5_WP*(this%Wfz(i,j,k)+abs(this%Wfz(i,j,k)))*sum(wenop*this%Q(i,j,k-2:k  ,1))&
                &            -0.5_WP*(this%Wfz(i,j,k)-abs(this%Wfz(i,j,k)))*sum(wenom*this%Q(i,j,k-1:k+1,1))
                ! Centered mass flux
                ...
                FQz(i,j,k,5)=FQz(i,j,k,1)*0.5_WP*sum(this%W(i,j,k-1:k))-this%Pfz(i,j,k)
                ! Heat fluxes
       ...
       do k=this%cfg%kmin_,this%cfg%kmax_
          do j=this%cfg%jmin_,this%cfg%jmax_
             do i=this%cfg%imin_,this%cfg%imax_
                ...
                ! Pressure dilatation term (using cell centered P but face velocity div)
                dQdt(i,j,k,2)=dQdt(i,j,k,2)-this%P(i,j,k)*(this%dxi*(this%Ufx(i+1,j,k)-this%Ufx(i,j,k))+this%dyi*(this%Vfy(i,j+1,k)-this%Vfy(i,j,k))+this%dzi*(this%Wfz(i,j,k+1)-this%Wfz(i,j,k)))
             end do
          end do
       end do
       ...
       do k=this%cfg%kmin_-1,this%cfg%kmax_+1; do j=this%cfg%jmin_-1,this%cfg%jmax_+1; do i=this%cfg%imin_-1,this%cfg%imax_+1
          ...
          gradU(1,1)=this%dxi*(this%Ufx(i+1,j,k)-this%Ufx(i,j,k))
          gradU(2,1)=this%dyi*(this%Ufy(i,j+1,k)-this%Ufy(i,j,k))
          gradU(3,1)=this%dzi*(this%Ufz(i,j,k+1)-this%Ufz(i,j,k))
          gradU(1,2)=this%dxi*(this%Vfx(i+1,j,k)-this%Vfx(i,j,k))
          gradU(2,2)=this%dyi*(this%Vfy(i,j+1,k)-this%Vfy(i,j,k))
          gradU(3,2)=this%dzi*(this%Vfz(i,j,k+1)-this%Vfz(i,j,k))
          gradU(1,3)=this%dxi*(this%Wfx(i+1,j,k)-this%Wfx(i,j,k))
          gradU(2,3)=this%dyi*(this%Wfy(i,j+1,k)-this%Wfy(i,j,k))
          gradU(3,3)=this%dzi*(this%Wfz(i,j,k+1)-this%Wfz(i,j,k))
    ...
    subroutine get_viscartif(this,dt,beta)
       ...
       do k=this%cfg%kmin_,this%cfg%kmax_; do j=this%cfg%jmin_,this%cfg%jmax_; do i=this%cfg%imin_,this%cfg%imax_
          div(i,j,k)=(this%dxi*(this%Ufx(i+1,j,k)-this%Ufx(i,j,k))+this%dyi*(this%Vfy(i,j+1,k)-this%Vfy(i,j,k))+this%dzi*(this%Wfz(i,j,k+1)-this%Wfz(i,j,k)))
       end do; end do; end do
       ...
       do k=this%cfg%kmin_,this%cfg%kmax_; do j=this%cfg%jmin_,this%cfg%jmax_; do i=this%cfg%imin_,this%cfg%imax_
          ...
          dudy=this%dyi*(this%Ufy(i,j+1,k)-this%Ufy(i,j,k))
          dudz=this%dzi*(this%Ufz(i,j,k+1)-this%Ufz(i,j,k))
          dvdx=this%dxi*(this%Vfx(i+1,j,k)-this%Vfx(i,j,k))
          dvdz=this%dzi*(this%Vfz(i,j,k+1)-this%Vfz(i,j,k))
          dwdx=this%dxi*(this%Wfx(i+1,j,k)-this%Wfx(i,j,k))
          dwdy=this%dyi*(this%Wfy(i,j+1,k)-this%Wfy(i,j,k))
